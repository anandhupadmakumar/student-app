...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return GetBuilder<HomeController>(builder: (searchData) {
      return Container(
        // color: Colors.amber
        // ,
        // height: 750.h,
                      ...
                      return InkWell(
                        onTap: () async {
                          await homeController.getCourseDetails(
                              courseName: searchData.searchResultList[index]
                                      ['Course_Name'] ??
                                  '',
                              courseId: searchData.searchResultList[index]
                                  ['Course_Id']);
                        },
                        child: Container(
                            ...
                            child: Card(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      searchData.searchResultList[index]
                                          ['Course_Name'],
                                    ...
                                    Text(searchData.searchResultList[index]
                                        ['Country_Name']),
                                  ],
                                ),
                              ),
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                        onPressed: () async {
                          if (homeController.pageNumber.value > 1) {
                            ...
                            final pageStartNumber =
                                (homeController.pageNumber.value * 10) - 10;
                            final pageEndNumber =
                                (homeController.pageNumber.value * 10);
                    ...
                    Container(
                      ...
                      child: Center(
                          child: Obx(() =>
                              Text(homeController.pageNumber.toString()))),
                    ),
                    IconButton(
                        onPressed: () async {
                          homeController.pageNumber.value++;
